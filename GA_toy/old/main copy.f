...
c==================================================================
   ...
   10 continue
      ...
      do 11 i=1,500
         read(8,*,end=999) obs(i)
   11 continue
  999 continue
      m=i-1      ! number of observation
c==================================================================  
c     Now call pikaia
...
c     output
      ...
      write(9,*) f
      write(9,*)
      write(9,*) 'pikaia control parameters'
      write(9,9000) ctrl
      write(9,*)
      write(9,*) 'Observations.......Predictions'
      do 12 i=1,5
         write(9,*) obs(i),pred(i)
   12 continue
    
c==================================================================  
 9000 format('    ctrl: ',f11.6,4x,1pe10.2e3,3x,4(f11.6,3x)/
     &  10x,6(f11.6,3x))
...
c==========================================================
      implicit none
      integer n,i,m
      real*8 x(n), sum, loss, par(n), obs(100), y(100)

      COMMON/EXP/obs
      COMMON/COUNT/m     ! number of observational data points
...
c     Constants
      ...
      parameter (NMAX = 32, PMAX = 1000, DMAX = 12)
c
